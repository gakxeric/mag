...
<div id="dashboard">
	...
	<!-- side content -->
        ...
        <div>
	       ...
	       <tbody> 
	         <tr> 
		         <td><a href="editpost.php">HELLO WORLD</a></td> 
		         <td>PUBLISHED</td> 
		         <td>Eric</td>
		         <td>Sports</td>
		         <td>22</td>
		...
		<div id="dashboard_sidemenu">
		   <nav class="nav-sidebar">
		   	<ul class="nav tabs">
		   		<li><a href="editor_menu.php" class="active">Edit posts</a></li>
		   		<li><a href="editor_media.php">Media</a></li>
		   		<li><a href="editor_post.php">Post</a></li>
		   	</ul>
		   </nav>
		</div>
	</div>
